...
#include "EquippableMeleeWeapon.generated.h"

/**
 * 
 */
UCLASS(Blueprintable)
class HOWITBEGAN_API UEquippableMeleeWeapon : public UEquippableItem
{
	GENERATED_BODY()
public:
	UEquippableMeleeWeapon();
	...
	TSubclassOf<class AMeleeWeaponClass> WeaponClass;
};
